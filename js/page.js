            ...
            success: function(msg) {
                ...
                for (let i = 0; i < msg.length; i++) {
                    str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                        "<td align='center'>" + (msg[i].t1 / 10) + "</td>" +
                        "<td align='center'>" + (msg[i].t2 / 10) + "</td>" +
                        "<td align='center'>" + (msg[i].t3 / 10) + "</td>" +
                        "<td align='center'>" + (msg[i].t4 / 10) + "</td>" +
                        "<td align='center'>" + (msg[i].t5 / 1000) + "</td>" +
                        "<td align='center'>" + (msg[i].t6 / 1000) + "</td>" +
                        "<td align='center'>" + (msg[i].t7 / 1000) + "</td>" +
                        "<td align='center'>" + (msg[i].t8 / 1000) + "</td>" +
                        "<td align='center'>" + (msg[i].t9 / 100) + "</td>" +
                        "<td align='center'>" + (msg[i].t10 / 1000) + "</td>" +
                        "<td align='center'>" + (msg[i].t11 / 10) + "</td>" +
                        "<td align='center'>" + (msg[i].t12 / 100) + "</td>" +
                        "<td align='center'>" + (msg[i].t13 / 10) + "</td>" +
                        "<td align='center'>" + msg[i].t14 + "</td>" +
                        "<td align='center'>" + msg[i].t15 + "</td>" +
                        "<td align='center'>" + msg[i].t16 + "</td>" +
                        "<td align='center'>" + (msg[i].t17 / 100) + "</td>" +
                        "</tr>"
                }
                ...
                success: function(msg) {
                    ...
                    for (let i = 0; i < msg.length; i++) {
                        str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                            ...
                            "<td align='center'>" + msg[i].t16 + "</td>" +
                            "<td align='center'>" + (msg[i].t17 / 100) + "</td>" +
                            "<td align='center'>" + (msg[i].t18 / 100) + "</td>" +
                            "<td align='center'>" + (msg[i].t19 / 100) + "</td>" +
                            "<td align='center'>" + (msg[i].t20 / 100) + "</td>" +
                            "<td align='center'>" + (msg[i].t21 / 100) + "</td>" +
                            "<td align='center'>" + (msg[i].t22 / 100) + "</td>" +
                            "</tr>"
                    }
                    ...
                    success: function(msg) {
                        ...
                        for (let i = 0; i < msg.length; i++) {
                            str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                ...
                                "<td align='center'>" + (msg[i].t21 / 100) + "</td>" +
                                "<td align='center'>" + (msg[i].t22 / 100) + "</td>" +
                                "<td align='center'>" + (msg[i].t23 / 10) + "</td>" +
                                "</tr>"
                        }
                        ...
                        success: function(msg) {
                            ...
                            for (let i = 0; i < msg.length; i++) {
                                str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                    ...
                                    "<td align='center'>" + msg[i].t3 / 10 + "</td>" +
                                    "<td align='center'>" + msg[i].t4 / 10 + "</td>" +
                                    "<td align='center'>" + msg[i].t5 / 10 + "</td>" +
                                    "<td align='center'>" + msg[i].t6 / 10 + "</td>" +
                                    "<td align='center'>" + msg[i].t7 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t8 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t9 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t10 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t11 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t12 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t13 / 100 + "</td>" +
                                    "<td align='center'>" + msg[i].t14 / 1000 + "</td>" +
                                    "<td align='center'>" + msg[i].t15 + "</td>" +
                                    "<td align='center'>" + msg[i].t16 / 100 + "</td>" +
                                    "<td align='center'>" + msg[i].t17 / 10 + "</td>" +
                                    "<td align='center'>" + msg[i].t18 / 100 + "</td>" +
                                    "<td align='center'>" + msg[i].t19 / 10 + "</td>" +
                                    ...
                                    "<td align='center'>" + msg[i].t27 / 100 + "</td>" +
                                    "<td align='center'>" + msg[i].t28 / 100 + "</td>" +
                                    "</tr>"
                            }
                            ...
                            success: function(msg) {
                                ...
                                for (let i = 0; i < msg.length; i++) {
                                    str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                        ...
                                        "<td align='center'>" + msg[i].t27 / 100 + "</td>" +
                                        "<td align='center'>" + msg[i].t28 / 100 + "</td>" +
                                        "<td align='center'>" + msg[i].t29 / 100 + "</td>" +
                                        "<td align='center'>" + msg[i].t30 / 100 + "</td>" +
                                        "<td align='center'>" + msg[i].t31 / 100 + "</td>" +
                                        "<td align='center'>" + msg[i].t32 / 100 + "</td>" +
                                        "<td align='center'>" + msg[i].t33 / 100 + "</td>" +
                                        "</tr>"
                                }
                                ...
                                success: function(msg) {
                                    ...
                                    for (let i = 0; i < msg.length; i++) {
                                        str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                            ...
                                            "<td align='center'>" + msg[i].t32 / 100 + "</td>" +
                                            "<td align='center'>" + msg[i].t33 / 100 + "</td>" +
                                            "<td align='center'>" + msg[i].t34 / 100 + "</td>" +
                                            "</tr>"
                                    }
                                    ...
                                    success: function(msg) {
                                        ...
                                        for (let i = 0; i < msg.length; i++) {
                                            str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                                ...
                                                "<td align='center'>" + msg[i].t33 / 100 + "</td>" +
                                                "<td align='center'>" + msg[i].t34 / 100 + "</td>" +
                                                "<td align='center'>" + msg[i].t35 / 100 + "</td>" +
                                                "</tr>"
                                        }
                                        ...
                                        success: function(msg) {
                                            ...
                                            for (let i = 0; i < msg.length; i++) {
                                                str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                                    ...
                                                    "<td align='center'>" + msg[i].t11 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t12 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t13 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t14 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t15 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t16 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t17 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t18 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t19 + "</td>" +
                                                    "<td align='center'>" + msg[i].t20 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t21 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t22 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t23 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t24 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t25 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t26 + "</td>" +
                                                    ...
                                                    "<td align='center'>" + msg[i].t36 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t37 / 100 + "</td>" +
                                                    "</tr>"
                                            }
                                        ...
                                        success: function(msg) {
                                            ...
                                            for (let i = 0; i < msg.length; i++) {
                                                str += "<tr>" + "<td align='center'>" + msg[i].reportTime + "</td>" +
                                                    ...
                                                    "<td align='center'>" + msg[i].t5 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t6 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t7 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t8 / 10 + "</td>" +
                                                    "<td align='center'>" + msg[i].t9 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t10 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t11 / 1000 + "</td>" +
                                                    "<td align='center'>" + msg[i].t12 / 1000 + "</td>" +
                                                    ...
                                                    "<td align='center'>" + msg[i].t36 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t37 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t38 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t39 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t40 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t41 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t42 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t43 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t44 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t45 / 100 + "</td>" +
                                                    "<td align='center'>" + msg[i].t46 / 100 + "</td>" +
                                                    "</tr>"
                                            }
